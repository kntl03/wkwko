...
 
		...
		$postdata = "email=".$email."&password=".$pass."&source=Android.google-play&signkey=".md5(rand(0000000000, 999999999999)).md5(rand(0000000000000, 99999999999999))."&android_id=".rand(00000000, 9999999999)."&version=3.5.10&gaid=3cc83187-89ae-492f-ab53-".rand(0000000000, 9999999999)."&gaid_enabled=true";
